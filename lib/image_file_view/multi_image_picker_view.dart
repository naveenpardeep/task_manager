...
class NsgMultiImagePickerView extends StatefulWidget {
  const NsgMultiImagePickerView(
      {Key? key,
  ...
  final NsgMultiImagePickerController controller;
  ...
  @override
  State<NsgMultiImagePickerView> createState() => _NsgMultiImagePickerViewState();
}

class _NsgMultiImagePickerViewState extends State<NsgMultiImagePickerView> {
  ...
  @override
  void didUpdateWidget(NsgMultiImagePickerView? oldWidget) {
